...
{
    public class LeaseDetailsAudit : BaseModelAudit
    {
        [Column(Order = 10)]
        [Display(Name = "Lease Application Reference No.")]
        public string leaseApplicationRef { get; set; }

        [Column(Order = 11)]
        [Display(Name = "Lease Reference No")]
        ...
        [Column(TypeName = "date", Order = 22)]
        public DateTime? StatementDate { get; set; }

        [Display(Name = "Escalation Date")]
        [Column(TypeName = "date", Order = 23)]
        ...
        //Business Activities Details (Applicable to RED Leases)

        [Display(Name = "Type of Activities")]
        [Column(Order = 31)]
        public string TypeOfActivities { get; set; }

        [Display(Name = "Compliance Details ")]
        [Column(Order = 32)]
        public string ComplianceDetails { get; set; }

        //Documents as well to be added on this section

        //leasing address-------------------------
        [Display(Name = "Address")]
        [Column(Order = 33)]
        [StringLength(500)]
        public string LeaAddress { get; set; }

        [Display(Name = "Postal Code")]
        [Column(Order = 34)]
        [StringLength(50)]
        public string LeaPostal { get; set; }

        [Display(Name = "Suburb")]
        [Column(Order = 35)]
        //[StringLength(10)]
        public string LeaSuburb { get; set; }
